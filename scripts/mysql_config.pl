...
my $ldata   = '/Users/chengwenjie/Downloads/percona-server-5.6.24-72.2/work/data';
my $execdir = '/Users/chengwenjie/Downloads/percona-server-5.6.24-72.2/work/bin';
my $bindir  = '/Users/chengwenjie/Downloads/percona-server-5.6.24-72.2/work/bin';

# ----------------------------------------------------------------------
# If installed, search for the compiled in directory first (might be "lib64")
# ----------------------------------------------------------------------

my $pkglibdir = fix_path('/Users/chengwenjie/Downloads/percona-server-5.6.24-72.2/work/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('/Users/chengwenjie/Downloads/percona-server-5.6.24-72.2/work/include', "include/mysql", "include");
